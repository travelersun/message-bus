package com.messagebus.managesystem.service.daemon;
...
public class ServiceLoader {
    ...
    private static final String packageStr = "com.messagebus.service.daemon.impl";
    ...
    public void registerRunOnceService(String serviceName, IService service) {
        if (isStarted) {
            throw new RuntimeException("can not register run once service, because the service cron has been started");
        }

        this.runOnceServiceMap.put(serviceName, service);
    }

    public void registerScheduleCycleService(String serviceName, IService service) {
        if (isStarted) {
            throw new RuntimeException("can not register schedule cycle service, because the service cron has been started");
        }

        this.scheduleCycleServiceMap.put(serviceName, service);
    }

    public Map<String, IService> getRunOnceServiceMap() {
        return runOnceServiceMap;
    }

    public Map<String, IService> getScheduleCycleServiceMap() {
        return scheduleCycleServiceMap;
    }
