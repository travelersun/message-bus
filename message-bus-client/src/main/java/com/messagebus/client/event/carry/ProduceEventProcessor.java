...
public class ProduceEventProcessor extends CommonEventProcessor {
    ...
    public void onValidate(ValidateEvent event) {
        ...
        if (!(context.getCarryType().equals(MessageCarryType.PRODUCE) || context.getCarryType().equals(MessageCarryType.PRODUCE_CONSUME))) {
        ...
        if (!(MessageCarryType.lookup(context.getSink().getType()).equals(MessageCarryType.CONSUME) || MessageCarryType.lookup(context.getSink().getType()).equals(MessageCarryType.PRODUCE_CONSUME))) {
