...
public class ResponseEventProcessor extends CommonEventProcessor {
    ...
    public void onPermissionCheck(PermissionCheckEvent event) {
        ...
        boolean            hasPermission = MessageCarryType.lookup(sink.getType()).equals(MessageCarryType.RESPONSE) || MessageCarryType.lookup(sink.getType()).equals(MessageCarryType.REQUEST_REQUEST);
