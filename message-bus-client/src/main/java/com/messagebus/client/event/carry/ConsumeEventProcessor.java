...
public class ConsumeEventProcessor extends CommonEventProcessor {
    ...
    public void onPermissionCheck(PermissionCheckEvent event) {
        ...
        hasPermission = (MessageCarryType.lookup(sink.getType()).equals(MessageCarryType.CONSUME) || MessageCarryType.lookup(sink.getType()).equals(MessageCarryType.PRODUCE_CONSUME))
