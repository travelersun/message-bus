...
public class SubscribeEventProcessor extends CommonEventProcessor {
    ...
    public void onPermissionCheck(PermissionCheckEvent event) {
        ...
        boolean hasPermission = MessageCarryType.lookup(sink.getType()).equals(MessageCarryType.SUBSCRIBE) || MessageCarryType.lookup(sink.getType()).equals(MessageCarryType.PUBLISH_SUBSCRIBE);
