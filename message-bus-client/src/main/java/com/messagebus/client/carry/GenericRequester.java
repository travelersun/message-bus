...
class GenericRequester extends AbstractMessageCarryer implements IRequester {
    ...
    public Message request(String secret, String to, Message msg,
        ...
        ConfigManager.Sink sink = this.getContext().getConfigManager().getSinkByName(secret,to);
        ctx.setSink(sink);
    ...
    public byte[] primitiveRequest(String secret,
        ...
        ConfigManager.Sink   sink   = this.getContext().getConfigManager().getSinkByName(secret,target);
